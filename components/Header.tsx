...
const Header = () => {
	...
	const logo = <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="44" height="45.651" viewBox="0 0 44 45.651">
	...
	return <>
		<header style={{
			...
			minHeight: '70px'
				...
				<div className="" style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', flex: 1  }}>
					<div className="" style={{padding: '8px'}}>
						<svg xmlns="http://www.w3.org/2000/svg" width="35" height="21.001" viewBox="0 0 35 21.001">
  							<path d="M314,16V13h35v3Zm0-9V4h35V7Zm0-9V-5h35v3Z" transform="translate(-314 5)" fill="#d6d7dd"/>
						</svg>
					</div>
				</div>
				<div className="" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexGrow: 1, flex: 2 }}>{ logo }</div>
				<div className="" style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', flex: 1 }}>
					<div className="" style={{padding: '8px'}}>
					...
					<div className="" style={{padding: '12px', position: 'relative'}}>
